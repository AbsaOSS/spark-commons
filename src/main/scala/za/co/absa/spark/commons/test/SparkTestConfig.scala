...
case class SparkTestConfig(allConfigs: Map[String, String], dependencies: String)

object SparkTestConfig {

  def getConfig(confDir: String, distJarsDir: String, sparkConfigs: Map[String, String]): SparkTestConfig = {
    val hadoopConfigs = getHadoopConfigurationForSpark(confDir)
    ...
    SparkTestConfig(allConfigs, deps)
  }
