...
import za.co.absa.spark.commons.common.SparkCompatibility
import za.co.absa.commons.version.impl.SemVer20Impl.SemanticVersion

object SparkVersionGuard {

  /**
   * Populates the version guard with the defaults from [[za.co.absa.spark.commons.common.SparkCompatibility]]
   */
