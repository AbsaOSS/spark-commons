...
class ExplosionSuite extends AnyFunSuite with SparkTestBase {
  ...
  test("Test a array of array sequence of explosions") {
    ...
    assertResults(explodedDf2, expectedExplodedResults, Seq("value_id", "value_id_1")) //autogenerated values cannot be tested against
  ...
  test("Test multiple nesting of arrays and structs") {
    ...
    // the following columns contain autogenerated values not possible to predict
    val exploded_id_columns = Seq(
      "legs_id",
      "legs_conditions_id",
      "legs_conditions_checks_id",
      "legs_conditions_checks_checkNums_id"
    )
    ...
    assertResults(explodedDf4, expectedExplodedResults, exploded_id_columns)
  ...
  test("Test exploding a nested array that is the only element of a struct") {
    ...
    assertSchema(explodedDf.schema, expectedExplodedSchema)
    assertResults(explodedDf, expectedExplodedResults, Seq("leg_conditions_id")) //autogenerated value in column cannot be predicted
