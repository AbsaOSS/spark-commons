...
/**
 * Trait offers a presumably very common implementation of [[za.co.absa.spark.commons.errorhandler.ErrorHandler.transformErrorSubmitToColumn ErrorHandler.transformErrorSubmitToColumn()]],
 * where the error is transformed into the struct of [[za.co.absa.spark.commons.errorhandler.ErrorMessage ErrorMessage]].
 *
