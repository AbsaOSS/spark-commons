...
/**
 * Class to unify a representation of a [[za.co.absa.spark.commons.errorhandler.ErrorMessageSubmit ErrorMessageSubmit]] segments.
 * It can be build from `column`,column name or a set of column names, a constant value and others.
 * The class then provides the ability to express each option as a Spark column used in other [[za.co.absa.spark.commons.errorhandler.ErrorHandler ErrorHandler]]
 * classes and methods.
 *
