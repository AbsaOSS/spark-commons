...
lazy val `sparkCommons` = (projectMatrix in file("spark-commons"))
  ...
  .settings(
    jacocoReportSettings := commonJacocoReportSettings.withTitle(s"spark-commons Jacoco Report - scala: ${scalaVersion.value}"),
...
lazy val sparkCommonsTest = (projectMatrix in file("spark-commons-test"))
  ...
  .settings(
    jacocoReportSettings := commonJacocoReportSettings.withTitle(s"spark-commons-test Jacoco Report - scala:${scalaVersion.value}"),
